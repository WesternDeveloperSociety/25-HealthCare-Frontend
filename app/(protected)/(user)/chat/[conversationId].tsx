...
export default function ChatRoomScreen() {
    ...
    const { data: messagesData, isLoading, refetch } = useQuery({
        ...
        queryFn: () => apiClient.get('/messages/:conversationId', { params: { conversationId: conversationId! } }),
        enabled: !!conversationId
    });

    const { mutate: sendMessage } = useMutation({
        mutationFn: (content: string) => apiClient.post('/messages/:conversationId', { content }, { params: { conversationId: conversationId! } }),
        onSuccess: () => {
            refetch();
